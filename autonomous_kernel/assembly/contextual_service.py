...
from .contextual import ContextualAssemblyError, ContextualAssemblyReceipt, ModelContextProfile, contextualize_prediction
...
def contextual_assemble_and_record(root: Path, frame: RepresentationFrame, component_predictions: Sequence[Prediction], registry: ModelRegistry, context: MarketContextFrame, profiles: Sequence[ModelContextProfile], *, assembly_at_ns: int) -> Tuple[Prediction, ContextualAssemblyReceipt]:
    """Canonical durable Z8+Z9 entrypoint; Z8 remains independently replayable."""
